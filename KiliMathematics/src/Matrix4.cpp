...
Vector3 Matrix4::transformVector3(const Vector3& vector, const float w) const
{
	Vector3 result;

	result.x = vector.x * mat[0][0] + vector.y * mat[1][0] + vector.z * mat[2][0] + w * mat[3][0];
	result.y = vector.x * mat[0][1] + vector.y * mat[1][1] + vector.z * mat[2][1] + w * mat[3][1];
	result.z = vector.x * mat[0][2] + vector.y * mat[1][2] + vector.z * mat[2][2] + w * mat[3][2];
...
Matrix4 Matrix4::createLookAt(const Vector3& eye, const Vector3& target, const Vector3& up)
{
	...
	const Vector3 xAxis = up.cross(zAxis);
...
const Matrix4 Matrix4::Identity = Matrix4(g4IdentRow);
